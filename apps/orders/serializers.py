...
class OrderItemSerializer(serializers.ModelSerializer):
    ...
    return_request_summary  = serializers.SerializerMethodField()
    ...
    class Meta:
        ...
        fields = [
            ...
            "return_request_summary", "return_window_blocked", "commission_breakup",
        ]
    ...
    def get_return_request_summary(self, obj):
        return [
            {
                "id":           str(rr.id),
                "request_type": rr.request_type,
                "status":       rr.status,
                "raised_at":    rr.created_at,
                "reviewed_at":  rr.reviewed_at,
                "completed_at": rr.completed_at,
            }
            for rr in obj.return_requests.order_by("created_at")
        ]
